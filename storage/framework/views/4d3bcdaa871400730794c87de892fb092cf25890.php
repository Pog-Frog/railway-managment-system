  ...
  <!-- 
	...
	<body>
		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="index.html"><i class="icon-airplane"></i>Egypt Railway</a></h1>
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="<?php echo e(route('user_login_index')); ?>">Login</a></li>
							<li><a href="<?php echo e(route('user_register_index')); ?>">Register</a></li>
                            <?php endif; ?>
						</ul>
					</nav>
				</div>
		...
		<div class="fh5co-hero" style="background-image: url(pics/user/road_1.jpg);">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: <?php echo e(URL::asset('pics/user/road_1.jpg')); ?>">
				<div class="desc">
					<div class="container">
						<div class="row">
										...
										<div class="row">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													...
													<input type="text" class="form-control" id="from-place" placeholder="Alexandria"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">To:</label>
													<input type="text" class="form-control" id="to-place" placeholder="Aswan"/>
												</div>
											</div>
											...
											<div class="col-sm-12 mt">
												<section>
													...
													<select class="cs-select cs-skin-border">
														...
														<option value="first">Sleeper Train</option>
											...
											<div class="col-xs-12">
												<input type="submit" class="btn btn-primary btn-block" value="Search Trip">
											</div>
										</div>
									 </div>
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Trip to Luxor via Cairo Airport</h3>
...
<?php /**PATH D:\Programming Projects\Repositories\temp\railway-managment-system\resources\views/user/home.blade.php ENDPATH**/ ?>